                    ...
                    <GroupBox DockPanel.Dock="Top" Margin="10,10,10,0" Padding="8,0,8,8" Height="505">
                        <StackPanel Margin="0,0,0,-8">
                            ...
                            <Border CornerRadius="4" BorderBrush="Gray" BorderThickness="1" Background="White" Margin="2,10,0,0" Width="735">
                                <ListBox x:Name="RolesListBox" Height="234" Margin="3,10,9,0" SelectionMode="Multiple" BorderBrush="{x:Null}" >
                                    <ListBox.ItemTemplate>
                                        <DataTemplate>
                                            <CheckBox Content="{Binding DisplayName}" IsEnabled="{Binding IsSelectable}" Foreground="{Binding Foreground}" Padding="4,0,0,0" VerticalContentAlignment="Center" Style="{DynamicResource ToggleSwitch}" FontSize="14" />
                                        </DataTemplate>
                                    </ListBox.ItemTemplate>            
                                </ListBox>
                            </Border>
                            <Label x:Name="lblReason" Content="Reason" FontSize="14" HorizontalAlignment="Left" VerticalAlignment="Top" Margin="10,10,0,0"/>
                            <TextBox x:Name="ReasonTextBox" Height="23" Width="730"/>
                            <Label x:Name="lblDuration" Content="Duration (hours)" FontSize="14" HorizontalAlignment="Left" VerticalAlignment="Top" Margin="10,10,0,0"/>
                            <TextBox x:Name="DurationTextBox" Height="23" Width="104" HorizontalAlignment="Left" Margin="14,0,0,0"/>
                            <Label x:Name="lblPreviousSelections" Content="Previous Selections" FontSize="14" HorizontalAlignment="Left" VerticalAlignment="Top" Margin="10,10,0,0"/>
                            <ComboBox x:Name="HistoryComboBox" Height="23" Width="730" HorizontalAlignment="Left" Margin="10,5,0,0"/>
                        </StackPanel>
                    </GroupBox>
